...
--
-- This snippet configures nvim-cmp, an autocompletion plugin for neovim. It
-- provides autocompletion for text in the current buffer, file system paths, and
-- snippets. It also provides autocompletion from the language server protocol
-- (LSP) servers that are running in the background.
return {
	"hrsh7th/nvim-cmp",
	event = "InsertEnter",
	dependencies = {
